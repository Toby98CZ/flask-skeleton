...
Revision ID: 466734e3f929
Revises: None
Create Date: 2016-10-20 17:07:21.454351

"""

# revision identifiers, used by Alembic.
revision = '466734e3f929'
down_revision = None
...
def upgrade():
    ...
    op.create_table('Hodnoty',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('hodnota1', sa.String(), nullable=False),
    sa.Column('hodnota2', sa.String(), nullable=False),
    sa.Column('datum_insertu', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id', name='pk_Hodnoty'),
    sqlite_autoincrement=True
    )
    op.create_index('ix_Hodnoty_hodnota2', 'Hodnoty', ['hodnota2'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ix_Hodnoty_hodnota2', table_name='Hodnoty')
    op.drop_table('Hodnoty')
